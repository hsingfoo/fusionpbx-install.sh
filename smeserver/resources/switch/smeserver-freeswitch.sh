...
yum -y -q install ffmpeg lame memcached ghostscript ilbc2 --enablerepo=okay,epel
yum -y -q install *1.6.15-1* freeswitch-sounds-en-us-callie-all freeswitch-sounds-music --enablerepo=okay,epel,remi
