...
echo "Installation of Freeswitch 1.6, FusionPBX 4.2, PostgreSQL 9.4, memcached, SCL php and php-fpm on SME Server 9.1"

#Install and configure Remi PHP versions
echo "Installing SCL php versions"
...
echo "Installing memached and php-fpm"
...
echo "Pre-configuration for SME Server done"
